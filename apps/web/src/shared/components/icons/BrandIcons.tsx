...
export function FaWhatsapp(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 448 512"
      width="1em"
...
/** Filled bookmark (Bootstrap Icons `bookmark-fill`, MIT). */
export function BsBookmarkFill(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 16 16"
      width="1em"
