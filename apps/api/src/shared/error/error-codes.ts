 ...
 * envelope). One entry per code the code base actually throws or responds
 * with — `error-codes.spec.ts` pins the count and the locale parity, so adding
 * a code means adding its message to `i18n/locales/{pt-BR,en,es}/errors.json`.
 */
